...
public class Game implements Comparable<Game> {
	...
	@ManyToOne @JoinColumn(name = "homeTeamId", nullable = true, insertable = false, updatable = false)
	private Team homeTeam;
	@Column
	private Integer homeScore;
	@Column
	private Integer visitorTeamId;
	@ManyToOne @JoinColumn(name = "visitorTeamId", nullable = true, insertable = false, updatable = false)
	...
	public boolean isFrom(League league) {
		return (homeTeam != null && homeTeam.getLeague() == league) || (visitorTeam != null && visitorTeam.getLeague() == league);
	}
	...
	public String toString() {
		return "Game [id=" + id + ", date=" + date + ", homeTeamId=" + homeTeamId + ", homeTeam=" + homeTeam
				+ ", homeScore=" + homeScore + ", visitorTeamId=" + visitorTeamId + ", visitorTeam=" + visitorTeam
				+ ", visitorScore=" + visitorScore + ", cup=" + cup + ", statsUrl=" + statsUrl + ", isComplete=" + isComplete() + "]";
	}
