...
public class PlayerGame implements Comparable<PlayerGame> {
  ...
  public String toString() {
    return "PlayerGame [key=" + key + ", player=" + player + ", game=" + game + ", played=" + played
        + ", primary=" + primary + ", secondary=" + secondary + ", sets=" + sets + ", points="
        + points + ", aces=" + aces + ", blocks=" + blocks + ", recNumber=" + recNumber
        + ", recPct=" + recPct + ", mvp=" + mvp + "]";
  }
