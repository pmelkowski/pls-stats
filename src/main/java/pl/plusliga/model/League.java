...
public enum League {
	...
	ORLENLIGA(
			"http://www.lsk.plps.pl/teams.html",
			...
			Position.atakująca, Position.libero, Position.przyjmująca, Position.rozgrywająca, Position.środkowa
	),
	PLUSLIGA(
			"http://www.plusliga.pl/teams.html",
			...
			Position.atakujący, Position.libero, Position.przyjmujący, Position.rozgrywający, Position.środkowy
	);
	...
	League(String teamsUrl, String playersUrl, String gamesUrl, String cupGamesUrl, String suoerCupGameUrl, Position...positions) {
