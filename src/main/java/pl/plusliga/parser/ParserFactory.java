...
public class ParserFactory {
    ...
    private static final Map<Class<?>, Class<? extends JsoupParser<?>>> PLS_MAP = Stream.of(
            new SimpleEntry<>(Game.class, PlpsGameParser.class),
    ...
    private static final Map<League, Map<Class<?>, Class<? extends JsoupParser<?>>>> PARSER_MAP = Stream.of(
            new SimpleEntry<>(League.ORLENLIGA, PLS_MAP),
